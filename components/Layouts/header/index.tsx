    ...
    <header className="border-stroke shadow-1 dark:border-stroke-dark dark:bg-gray-dark sticky top-0 z-30 flex items-center justify-between border-b bg-white px-4 py-5 md:px-5 2xl:px-10">
      ...
      <div className="max-xl:hidden">
        ...
        {pathName.startsWith("/admin") ? (
          ...
          <p className="font-medium">MEMMIC Manager Dashboard Solution</p>
        ) : "Client Panel" }
      </div>
      ...
      <div className="2xsm:gap-4 flex flex-1 items-center justify-end gap-2">
        {/* <div className="relative w-full max-w-75">
          <input
            type="search"
            placeholder="Search"
            className="bg-gray-2 border-stroke focus-visible:outline-none! focus-visible:border-primary dark:border-dark-3 dark:bg-dark-2 dark:hover:border-dark-4 dark:hover:bg-dark-3 dark:hover:text-dark-6 dark:focus-visible:border-primary flex w-full items-center gap-3.5 rounded-[4px] border py-3 pr-5 pl-13.25 transition-colors outline-none"
          />
