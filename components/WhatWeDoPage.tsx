    ...
    <div className="bg-white">
      ...
      <section className="border-t border-gray-100 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12">
          <RevealGroup className="grid grid-cols-1 gap-10 sm:grid-cols-2 sm:gap-12 lg:grid-cols-4 lg:gap-10">
            {EMMIC_STEPS.map((step, i) => (
              <RevealItem key={step.number}>
                <Link
                  href={`/what-we-do/${EMMIC_STEP_SLUGS[i]}`}
                ...
                >
                  ...
                  <div className="mb-2 flex items-center gap-1.5">
                    ...
                    <ArrowUpRight
                      size={16}
                      className="text-gray-400 transition-colors duration-300 group-hover:text-gray-900"
                    />
                  </div>
